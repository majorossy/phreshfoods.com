...
export const FILTERABLE_FARM_ATTRIBUTES: string[] = Object.keys(FARM_PRODUCT_ICONS_CONFIG);

export const FARM_CATEGORY_DISPLAY_ORDER: string[] = ['Meats', 'Poultry & Eggs', 'Vegetables', 'Fruits', 'Aromatics'];
