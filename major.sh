...
while IFS='|' read -r name address city zip phone; do
  ...
  # Build a good query string for Places
  ...
  # Write CSV row (double-quoted, simple escaping assumption: no embedded double quotes)
  printf '"%s","%s","%s","%s","%s","%s"\n' \
...
Broad Arrow Farm Market & Butcher / The Rooting Pig|33 Benner Rd|Bristol|04539|(207) 553-0747
DATA
