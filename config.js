...
const DEFAULT_MAP_CENTER = { lat: 43.6926, lng: -70.0537 }; // Biddeford center
...
const mapStyles = {
    maineLicensePlate: [
        ...
        { featureType: "landscape.man_made", elementType: "geometry.stroke", stylers: [{ color: "#288b5c" }, { weight: 0.5 }] }, // Corrected from your HTML, was d8cbae
        { featureType: "landscape.natural", elementType: "geometry.fill", stylers: [{ color: "#1a6a41" }] }, // Corrected from your HTML, was a1b59c
